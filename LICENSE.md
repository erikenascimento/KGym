...
personal use, educational use, and evaluation. Commercial use,
including offering the Licensed Work as a hosted service or as part
of a paid product, is not permitted without explicit permission
from the Licensor.

Change Date: 2029-12-23

Change License: Apache License, Version 2.0

The following license text is reproduced from the Business Source License 1.1,
with formatting adjusted for readability.
